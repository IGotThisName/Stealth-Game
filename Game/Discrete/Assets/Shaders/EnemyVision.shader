Shader "EnemyVision"
{
    ...
    SubShader
    {
        ...
        SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
        {
            ...
            float4 Color_66d0ccd319dc4f40b6ab20b1c18aa2d5 = IsGammaSpace() ? float4(0.01512542, 0.5283019, 0, 0) : float4(SRGBToLinear(float3(0.01512542, 0.5283019, 0)), 0);
            ...
            float4 Color_1ca1006978c340fcb3d2428a47591e2b = IsGammaSpace() ? float4(1, 0.05991669, 0, 0) : float4(SRGBToLinear(float3(1, 0.05991669, 0)), 0);
            ...
            Unity_Multiply_float4_float4(Color_1ca1006978c340fcb3d2428a47591e2b, (_Power_5b4455e338b94ecb86a590d53c4b3bb4_Out_2.xxxx), _Multiply_a76c1244e8624538b3e2a4626fe0eb4d_Out_2);
